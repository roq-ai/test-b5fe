...
import { ProgressListPage as ShowCaseList } from 'pages/progresses';
...
function DashboardPage() {
  ...
  const trainingProgramStat = useSWR<PaginatedInterface<TrainingProgramInterface>>(
    () => `/training-programs`,
    () => getTrainingPrograms({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: trainingProgramStat?.data?.totalCount,
      isLoading: trainingProgramStat.isLoading,
    },
  ];
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`progresses`} passHref legacyBehavior>
                  <Button
